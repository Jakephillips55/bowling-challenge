describe('Frame', function() {
	...
	it('total pins knocked in this frame', function() {
		roll.addPin(pin);
		frame.addRoll(roll);
		expect(frame.totalPins()).toEqual(1);
	});

	it('knows if a spare', function() {
		makeSpare(frame);
